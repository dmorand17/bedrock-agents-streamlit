...
st.set_page_config(
    page_title="Co. Portfolio Creator", page_icon=":robot_face:", layout="wide"
)
...
if submit_button and prompt:
    event = {"sessionId": "MYSESSION115", "question": prompt}
    print("Calling lamdbda...")
    response = agenthelper.lambda_handler(event, None)
    print("Calling lamdbda [DONE]...")
    ...
    st.session_state["history"].append(
        {
            ...
            "answer": "Thank you for using AnyCompany Support Agent!",
        }
    )
    event = {
